...
- [↓ Roles, permissions, and user assignments](5.3.2.1-Roles-permissions-and-user-assignments.md)
- [↓ RBAC in Active Directory and Linux (SELinux)](5.3.2.2-RBAC-in-Active-Directory-and-Linux-SELinux.md)
- [↓ RBAC vs ABAC (Attribute-Based Access Control)](5.3.2.3-RBAC-vs-ABAC-Attribute-Based-Access-Control.md)

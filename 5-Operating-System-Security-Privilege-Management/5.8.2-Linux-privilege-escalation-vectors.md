...
- [↓ SUID/SGID binaries and sudo misconfigurations](5.8.2.1-SUIDSGID-binaries-and-sudo-misconfigurations.md)
- [↓ Kernel exploits and version vulnerabilities](5.8.2.2-Kernel-exploits-and-version-vulnerabilities.md)
- [↓ Cron jobs and PATH manipulation](5.8.2.3-Cron-jobs-and-PATH-manipulation.md)

...
- [↓ Profile levels: Level 1 (basic) vs Level 2 (enhanced)](5.9.1.1-Profile-levels-Level-1-basic-vs-Level-2-enhanced.md)
- [↓ Scored vs not scored recommendations](5.9.1.2-Scored-vs-not-scored-recommendations.md)
- [↓ Implementation guides and remediation procedures](5.9.1.3-Implementation-guides-and-remediation-procedures.md)

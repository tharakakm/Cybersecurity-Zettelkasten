...
- [↓ Enumeration tools: WinPEAS, LinPEAS, linux-exploit-suggester](5.8.3.1-Enumeration-tools-WinPEAS-LinPEAS-linux-exploit-suggester.md)
- [↓ Monitoring for suspicious privilege use](5.8.3.2-Monitoring-for-suspicious-privilege-use.md)
- [↓ Hardening configurations to prevent escalation](5.8.3.3-Hardening-configurations-to-prevent-escalation.md)

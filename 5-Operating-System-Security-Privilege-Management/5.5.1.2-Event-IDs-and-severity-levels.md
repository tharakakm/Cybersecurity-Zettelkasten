...
**ID:** 5.5.1.2
**Level:** 4
**Parent:** [Windows Event Log structure and categories](5.5.1-Windows-Event-Log-structure-and-categories.md)
**Tags:** #level4 #module5
...
- [→ Security, Application, System, Setup logs](5.5.1.1-Security-Application-System-Setup-logs.md)
- [→ Event Viewer navigation and filtering](5.5.1.3-Event-Viewer-navigation-and-filtering.md)

...
**ID:** 5.8.1
**Level:** 3
**Parent:** [Privilege escalation vulnerabilities and prevention](5.8-Privilege-escalation-vulnerabilities-and-prevention.md)
...
- [↓ Unquoted service paths and weak permissions](5.8.1.1-Unquoted-service-paths-and-weak-permissions.md)
- [↓ DLL hijacking and search order vulnerabilities](5.8.1.2-DLL-hijacking-and-search-order-vulnerabilities.md)
- [↓ Scheduled tasks and registry manipulation](5.8.1.3-Scheduled-tasks-and-registry-manipulation.md)

...
**ID:** 5.3.1
**Level:** 3
**Parent:** [Principle of least privilege and role-based access control (RBAC)](5.3-Principle-of-least-privilege-and-role-based-access-control-RBAC.md)
**Tags:** #level3 #module5
...
- [↓ Separation of duties and need-to-know basis](5.3.1.1-Separation-of-duties-and-need-to-know-basis.md)
- [↓ Privilege creep and periodic access reviews](5.3.1.2-Privilege-creep-and-periodic-access-reviews.md)
- [↓ Just-in-time (JIT) access and time-limited permissions](5.3.1.3-Just-in-time-JIT-access-and-time-limited-permissions.md)

**Related Topics at Same Level:**
- [→ Role-Based Access Control (RBAC) model](5.3.2-Role-Based-Access-Control-RBAC-model.md)

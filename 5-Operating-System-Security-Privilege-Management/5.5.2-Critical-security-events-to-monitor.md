...
- [↓ Logon events: 4624 (success), 4625 (failure)](5.5.2.1-Logon-events-4624-success-4625-failure.md)
- [↓ Account management: 4720 (created), 4726 (deleted)](5.5.2.2-Account-management-4720-created-4726-deleted.md)
- [↓ Privilege use and policy changes](5.5.2.3-Privilege-use-and-policy-changes.md)

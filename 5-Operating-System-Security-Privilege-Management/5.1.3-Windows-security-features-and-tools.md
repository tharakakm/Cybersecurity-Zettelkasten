...
- [↓ Windows Defender and anti-malware configuration](5.1.3.1-Windows-Defender-and-anti-malware-configuration.md)
- [↓ BitLocker disk encryption setup](5.1.3.2-BitLocker-disk-encryption-setup.md)
- [↓ Windows Security Center and security baselines](5.1.3.3-Windows-Security-Center-and-security-baselines.md)

...
- [↓ chown and chgrp: Changing ownership](5.2.2.1-chown-and-chgrp-Changing-ownership.md)
- [↓ umask: Default permission masks](5.2.2.2-umask-Default-permission-masks.md)
- [↓ Finding files by permissions: find with -perm](5.2.2.3-Finding-files-by-permissions-find-with--perm.md)

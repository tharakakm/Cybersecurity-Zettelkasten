...
- [↓ HIPAA compliance for healthcare data in cloud](8.9.1.1-HIPAA-compliance-for-healthcare-data-in-cloud.md)
- [↓ SOC 2 Type II attestation and requirements](8.9.1.2-SOC-2-Type-II-attestation-and-requirements.md)
- [↓ ISO 27001 certification in cloud environments](8.9.1.3-ISO-27001-certification-in-cloud-environments.md)

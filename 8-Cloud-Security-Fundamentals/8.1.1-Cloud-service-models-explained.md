...
- [↓ IaaS (Infrastructure as a Service): EC2, Azure VMs, compute resources](8.1.1.1-IaaS-Infrastructure-as-a-Service-EC2-Azure-VMs-compute-resources.md)
- [↓ PaaS (Platform as a Service): App Services, Lambda, serverless](8.1.1.2-PaaS-Platform-as-a-Service-App-Services-Lambda-serverless.md)
- [↓ SaaS (Software as a Service): Office 365, Salesforce, security implications](8.1.1.3-SaaS-Software-as-a-Service-Office-365-Salesforce-security-implications.md)

...
- [↓ Azure Active Directory and identity management](8.2.2.1-Azure-Active-Directory-and-identity-management.md)
- [↓ Azure Security Center and Microsoft Defender for Cloud](8.2.2.2-Azure-Security-Center-and-Microsoft-Defender-for-Cloud.md)
- [↓ Azure Policy and Blueprints for compliance](8.2.2.3-Azure-Policy-and-Blueprints-for-compliance.md)

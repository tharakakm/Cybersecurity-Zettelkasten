...
- [↓ TLS/SSL for data transfer](8.5.2.1-TLSSSL-for-data-transfer.md)
- [↓ VPN and Direct Connect/ExpressRoute encryption](8.5.2.2-VPN-and-Direct-ConnectExpressRoute-encryption.md)
- [↓ Enforcing HTTPS and secure protocols](8.5.2.3-Enforcing-HTTPS-and-secure-protocols.md)

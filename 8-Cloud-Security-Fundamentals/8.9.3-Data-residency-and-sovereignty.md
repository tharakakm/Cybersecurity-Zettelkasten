...
- [↓ Regional data storage requirements (GDPR, local laws)](8.9.3.1-Regional-data-storage-requirements-GDPR-local-laws.md)
- [↓ Cross-border data transfer considerations](8.9.3.2-Cross-border-data-transfer-considerations.md)
- [↓ Government cloud: AWS GovCloud, Azure Government](8.9.3.3-Government-cloud-AWS-GovCloud-Azure-Government.md)

...
- [↓ VNet architecture and subnetting](8.6.3.1-VNet-architecture-and-subnetting.md)
- [↓ Network Security Groups (NSG) and Application Security Groups](8.6.3.2-Network-Security-Groups-NSG-and-Application-Security-Groups.md)
- [↓ VNet peering and Azure Virtual WAN](8.6.3.3-VNet-peering-and-Azure-Virtual-WAN.md)

...
**ID:** 8.4.2.2
**Level:** 4
**Parent:** [Database and storage misconfigurations](8.4.2-Database-and-storage-misconfigurations.md)
**Tags:** #level4 #module8
...
- [→ Publicly exposed RDS, CosmosDB, DynamoDB instances](8.4.2.1-Publicly-exposed-RDS-CosmosDB-DynamoDB-instances.md)
- [→ Database encryption and backup security](8.4.2.3-Database-encryption-and-backup-security.md)

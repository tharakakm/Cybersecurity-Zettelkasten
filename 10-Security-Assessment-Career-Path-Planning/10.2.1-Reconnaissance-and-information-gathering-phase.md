...
**ID:** 10.2.1
**Level:** 3
**Parent:** [Conducting end-to-end security testing: Recon → Scanning → Exploitation → Reporting](10.2-Conducting-end-to-end-security-testing-Recon-Scanning-Exploitation-Reporting.md)
...
- [↓ Active reconnaissance and network mapping](10.2.1.2-Active-reconnaissance-and-network-mapping.md)
...
- [→ Exploitation and post-exploitation (authorized testing)](10.2.3-Exploitation-and-post-exploitation-authorized-testing.md)

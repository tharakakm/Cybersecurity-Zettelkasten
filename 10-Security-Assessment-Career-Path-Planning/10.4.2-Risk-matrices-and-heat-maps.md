...
- [↓ Likelihood vs impact risk matrix](10.4.2.1-Likelihood-vs-impact-risk-matrix.md)
- [↓ Asset criticality vs vulnerability severity heat map](10.4.2.2-Asset-criticality-vs-vulnerability-severity-heat-map.md)
- [↓ Color-coded risk prioritization](10.4.2.3-Color-coded-risk-prioritization.md)

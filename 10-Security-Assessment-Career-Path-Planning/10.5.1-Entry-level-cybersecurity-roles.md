...
- [↓ SOC Analyst Tier 1/2: Responsibilities and daily tasks](10.5.1.1-SOC-Analyst-Tier-12-Responsibilities-and-daily-tasks.md)
- [↓ Security Analyst: Vulnerability management and compliance](10.5.1.2-Security-Analyst-Vulnerability-management-and-compliance.md)
- [↓ IT Support with security focus: Help desk to security transition](10.5.1.3-IT-Support-with-security-focus-Help-desk-to-security-transition.md)

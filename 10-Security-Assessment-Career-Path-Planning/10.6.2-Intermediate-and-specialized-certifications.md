...
- [↓ Offensive Security OSCP: Penetration testing hands-on](10.6.2.1-Offensive-Security-OSCP-Penetration-testing-hands-on.md)
- [↓ GIAC certifications: GPEN, GCIH, GCIA, GSEC](10.6.2.2-GIAC-certifications-GPEN-GCIH-GCIA-GSEC.md)
- [↓ Cloud certifications: AWS Security Specialty, Azure Security Engineer](10.6.2.3-Cloud-certifications-AWS-Security-Specialty-Azure-Security-Engineer.md)

**Related Topics at Same Level:**
- [→ Entry-level certifications](10.6.1-Entry-level-certifications.md)
- [→ Advanced and management certifications](10.6.3-Advanced-and-management-certifications.md)

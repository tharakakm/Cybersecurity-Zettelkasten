...
- [↓ Ransomware gangs: LockBit, BlackCat, REvil](1.4.2.1-Ransomware-gangs-LockBit-BlackCat-REvil.md)
- [↓ Banking trojans and financial fraud operations](1.4.2.2-Banking-trojans-and-financial-fraud-operations.md)
- [↓ Dark web marketplaces and stolen data economy](1.4.2.3-Dark-web-marketplaces-and-stolen-data-economy.md)

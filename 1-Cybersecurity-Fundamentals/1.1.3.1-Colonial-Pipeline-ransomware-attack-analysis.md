...
**ID:** 1.1.3.1
**Level:** 4
**Parent:** [Review real-world attack scenarios and case studies](1.1.3-Review-real-world-attack-scenarios-and-case-studies.md)
...
- [→ SolarWinds supply chain compromise breakdown](1.1.3.2-SolarWinds-supply-chain-compromise-breakdown.md)
- [→ Local Sri Lankan cybersecurity incidents and response](1.1.3.3-Local-Sri-Lankan-cybersecurity-incidents-and-response.md)

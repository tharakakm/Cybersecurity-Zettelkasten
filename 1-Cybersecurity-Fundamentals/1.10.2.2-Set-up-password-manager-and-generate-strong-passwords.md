...
**ID:** 1.10.2.2
**Level:** 4
**Parent:** [Configure personal security baseline](1.10.2-Configure-personal-security-baseline.md)
**Tags:** #level4 #module1
...
- [→ Enable full disk encryption: BitLocker, FileVault, LUKS](1.10.2.1-Enable-full-disk-encryption-BitLocker-FileVault-LUKS.md)
- [→ Enable MFA on critical accounts: Email, banking, social media](1.10.2.3-Enable-MFA-on-critical-accounts-Email-banking-social-media.md)

...
- [↓ Bug bounty success in resume and portfolio](11.9.3.1-Bug-bounty-success-in-resume-and-portfolio.md)
- [↓ Private program invitations and exclusive opportunities](11.9.3.2-Private-program-invitations-and-exclusive-opportunities.md)
- [↓ Transitioning from bug bounties to full-time security roles](11.9.3.3-Transitioning-from-bug-bounties-to-full-time-security-roles.md)

**Related Topics at Same Level:**
- [→ Reputation metrics and ranking systems](11.9.1-Reputation-metrics-and-ranking-systems.md)
- [→ Strategies for building reputation](11.9.2-Strategies-for-building-reputation.md)

...
- [↓ Bug bounty policy as legal authorization](11.8.1.1-Bug-bounty-policy-as-legal-authorization.md)
- [↓ Testing only in-scope assets](11.8.1.2-Testing-only-in-scope-assets.md)
- [↓ Crossing legal lines: What to avoid](11.8.1.3-Crossing-legal-lines-What-to-avoid.md)

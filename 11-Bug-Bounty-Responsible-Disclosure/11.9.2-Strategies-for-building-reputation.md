...
**ID:** 11.9.2
**Level:** 3
**Parent:** [Building reputation on bug bounty platforms](11.9-Building-reputation-on-bug-bounty-platforms.md)
...
- [↓ Consistency: Regular submissions and quality reports](11.9.2.1-Consistency-Regular-submissions-and-quality-reports.md)
- [↓ Collaboration: Helping other researchers and community](11.9.2.2-Collaboration-Helping-other-researchers-and-community.md)
- [↓ Specialization: Becoming known for specific vulnerability types](11.9.2.3-Specialization-Becoming-known-for-specific-vulnerability-types.md)

**Related Topics at Same Level:**
- [→ Reputation metrics and ranking systems](11.9.1-Reputation-metrics-and-ranking-systems.md)
- [→ Leveraging reputation for career growth](11.9.3-Leveraging-reputation-for-career-growth.md)

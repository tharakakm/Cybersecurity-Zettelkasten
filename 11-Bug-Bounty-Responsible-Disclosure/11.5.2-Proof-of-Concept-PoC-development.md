...
- [↓ Minimal reproducible PoC vs elaborate demonstration](11.5.2.1-Minimal-reproducible-PoC-vs-elaborate-demonstration.md)
- [↓ Screenshots, videos, and supporting evidence](11.5.2.2-Screenshots-videos-and-supporting-evidence.md)
- [↓ PoC code and scripts: Safe and responsible](11.5.2.3-PoC-code-and-scripts-Safe-and-responsible.md)

**Related Topics at Same Level:**
- [→ Bug report structure and components](11.5.1-Bug-report-structure-and-components.md)
- [→ Impact assessment and articulation](11.5.3-Impact-assessment-and-articulation.md)

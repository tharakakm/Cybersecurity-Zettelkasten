...
**ID:** 11.2.3.2
**Level:** 4
**Parent:** [Vulnerability acceptance criteria](11.2.3-Vulnerability-acceptance-criteria.md)
...
- [→ Valid vulnerability types per program](11.2.3.1-Valid-vulnerability-types-per-program.md)
- [→ Severity thresholds and minimum requirements](11.2.3.3-Severity-thresholds-and-minimum-requirements.md)

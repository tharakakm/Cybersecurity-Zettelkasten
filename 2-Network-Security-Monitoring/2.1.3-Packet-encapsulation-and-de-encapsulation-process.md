...
**ID:** 2.1.3
**Level:** 3
**Parent:** [OSI and TCP/IP models: Understanding network communication layers](2.1-OSI-and-TCPIP-models-Understanding-network-communication-layers.md)
...
- [↓ Protocol Data Units (PDUs): Frames, packets, segments](2.1.3.3-Protocol-Data-Units-PDUs-Frames-packets-segments.md)

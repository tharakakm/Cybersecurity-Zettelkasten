...
**ID:** 2.4.1.3
**Level:** 4
**Parent:** [Wireshark interface and basic operations](2.4.1-Wireshark-interface-and-basic-operations.md)
...
- [→ Capture interfaces selection and promiscuous mode](2.4.1.1-Capture-interfaces-selection-and-promiscuous-mode.md)
- [→ Display filters vs capture filters](2.4.1.2-Display-filters-vs-capture-filters.md)

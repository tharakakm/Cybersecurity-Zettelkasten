...
- [↓ Document timeline of attack activities](2.10.3.1-Document-timeline-of-attack-activities.md)
- [↓ Extract IOCs: IP addresses, domains, file hashes](2.10.3.2-Extract-IOCs-IP-addresses-domains-file-hashes.md)
- [↓ Propose detection rules and mitigation strategies](2.10.3.3-Propose-detection-rules-and-mitigation-strategies.md)

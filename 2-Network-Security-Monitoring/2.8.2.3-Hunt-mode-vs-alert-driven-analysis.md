...
**ID:** 2.8.2.3
**Level:** 4
**Parent:** [Security Onion and open-source NSM stack](2.8.2-Security-Onion-and-open-source-NSM-stack.md)
**Tags:** #level4 #module2
...
- [→ Security Onion components: Suricata, Zeek, Elasticsearch](2.8.2.1-Security-Onion-components-Suricata-Zeek-Elasticsearch.md)
- [→ Alert triage and investigation workflow](2.8.2.2-Alert-triage-and-investigation-workflow.md)

...
**ID:** 2.9.2.3
**Level:** 4
**Parent:** [iptables/nftables configuration on Linux](2.9.2-iptablesnftables-configuration-on-Linux.md)
...
- [→ iptables chains: INPUT, OUTPUT, FORWARD](2.9.2.1-iptables-chains-INPUT-OUTPUT-FORWARD.md)
- [→ NAT and port forwarding rules](2.9.2.2-NAT-and-port-forwarding-rules.md)

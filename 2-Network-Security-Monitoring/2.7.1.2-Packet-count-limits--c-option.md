...
**ID:** 2.7.1.2
**Level:** 4
**Parent:** [tcpdump basic command syntax and options](2.7.1-tcpdump-basic-command-syntax-and-options.md)
...
- [→ Interface selection: tcpdump -i eth0](2.7.1.1-Interface-selection-tcpdump--i-eth0.md)
- [→ Saving to file: -w and reading: -r options](2.7.1.3-Saving-to-file--w-and-reading--r-options.md)

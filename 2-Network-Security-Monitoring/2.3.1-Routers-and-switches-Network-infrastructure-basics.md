...
- [↓ Router functions: Packet forwarding, NAT, default gateway](2.3.1.1-Router-functions-Packet-forwarding-NAT-default-gateway.md)
- [↓ Switch operations: MAC address tables, VLANs](2.3.1.2-Switch-operations-MAC-address-tables-VLANs.md)
- [↓ Layer 2 vs Layer 3 switches](2.3.1.3-Layer-2-vs-Layer-3-switches.md)

...
**ID:** 2.5.2.3
**Level:** 4
**Parent:** [Advanced BPF filter combinations](2.5.2-Advanced-BPF-filter-combinations.md)
...
- [→ Logical operators: and, or, not in BPF](2.5.2.1-Logical-operators-and-or-not-in-BPF.md)
- [→ Port ranges and multiple conditions](2.5.2.2-Port-ranges-and-multiple-conditions.md)

...
**ID:** 2.5.3.2
**Level:** 4
**Parent:** [Optimizing capture performance](2.5.3-Optimizing-capture-performance.md)
...
- [→ Capture file size management and ring buffers](2.5.3.1-Capture-file-size-management-and-ring-buffers.md)
- [→ Using capture filters to reduce data volume](2.5.3.3-Using-capture-filters-to-reduce-data-volume.md)

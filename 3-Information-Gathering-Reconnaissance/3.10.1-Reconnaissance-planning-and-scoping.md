...
- [↓ Define target: Use TryHackMe, HackTheBox, or authorized domain](3.10.1.1-Define-target-Use-TryHackMe-HackTheBox-or-authorized-domain.md)
- [↓ Set reconnaissance objectives and information requirements](3.10.1.2-Set-reconnaissance-objectives-and-information-requirements.md)
- [↓ Document legal authorization and ethical boundaries](3.10.1.3-Document-legal-authorization-and-ethical-boundaries.md)

**Related Topics at Same Level:**
- [→ Execute comprehensive reconnaissance](3.10.2-Execute-comprehensive-reconnaissance.md)
- [→ Analysis and professional reporting](3.10.3-Analysis-and-professional-reporting.md)

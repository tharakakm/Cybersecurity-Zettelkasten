...
- [↓ Transform Hub and available data sources](3.8.3.1-Transform-Hub-and-available-data-sources.md)
- [↓ Creating custom transforms for specific needs](3.8.3.2-Creating-custom-transforms-for-specific-needs.md)
- [↓ Exporting and reporting findings from Maltego](3.8.3.3-Exporting-and-reporting-findings-from-Maltego.md)

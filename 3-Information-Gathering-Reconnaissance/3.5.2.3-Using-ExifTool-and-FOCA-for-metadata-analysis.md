...
**ID:** 3.5.2.3
**Level:** 4
**Parent:** [Metadata extraction from online content](3.5.2-Metadata-extraction-from-online-content.md)
**Tags:** #level4 #module3
...
- [→ EXIF data from images: Geolocation, timestamps, devices](3.5.2.1-EXIF-data-from-images-Geolocation-timestamps-devices.md)
- [→ Document metadata: Authors, software versions, internal paths](3.5.2.2-Document-metadata-Authors-software-versions-internal-paths.md)

...
**ID:** 3.8.1.2
**Level:** 4
**Parent:** [Maltego interface and transform basics](3.8.1-Maltego-interface-and-transform-basics.md)
**Tags:** #level4 #module3
...
- [→ Maltego CE vs commercial versions](3.8.1.1-Maltego-CE-vs-commercial-versions.md)
- [→ Running transforms and building graphs](3.8.1.3-Running-transforms-and-building-graphs.md)

...
- [↓ Google Dorks: site:, filetype:, intitle:, inurl:](3.2.1.1-Google-Dorks-site-filetype-intitle-inurl.md)
- [↓ Finding exposed files: PDFs, spreadsheets, configuration files](3.2.1.2-Finding-exposed-files-PDFs-spreadsheets-configuration-files.md)
- [↓ Searching for specific vulnerabilities and misconfigurations](3.2.1.3-Searching-for-specific-vulnerabilities-and-misconfigurations.md)

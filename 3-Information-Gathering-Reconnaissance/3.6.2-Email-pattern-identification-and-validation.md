...
- [↓ Common email naming conventions](3.6.2.1-Common-email-naming-conventions.md)
- [↓ Email verification tools and techniques](3.6.2.2-Email-verification-tools-and-techniques.md)
- [↓ Identifying role-based vs personal email addresses](3.6.2.3-Identifying-role-based-vs-personal-email-addresses.md)

...
- [↓ Brute force enumeration with wordlists](3.4.2.1-Brute-force-enumeration-with-wordlists.md)
- [↓ DNS zone transfers (AXFR) and misconfigurations](3.4.2.2-DNS-zone-transfers-AXFR-and-misconfigurations.md)
- [↓ Certificate transparency logs for subdomain discovery](3.4.2.3-Certificate-transparency-logs-for-subdomain-discovery.md)

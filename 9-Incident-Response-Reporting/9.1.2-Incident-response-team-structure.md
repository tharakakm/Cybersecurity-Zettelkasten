...
**ID:** 9.1.2
**Level:** 3
**Parent:** [Incident response lifecycle: NIST SP 800-61 framework](9.1-Incident-response-lifecycle-NIST-SP-800-61-framework.md)
...
- [↓ CSIRT (Computer Security Incident Response Team) roles](9.1.2.1-CSIRT-Computer-Security-Incident-Response-Team-roles.md)
- [↓ Incident response coordinator, analysts, forensic specialists](9.1.2.2-Incident-response-coordinator-analysts-forensic-specialists.md)
- [↓ Communication with management, legal, PR teams](9.1.2.3-Communication-with-management-legal-PR-teams.md)

**Related Topics at Same Level:**
- [→ NIST SP 800-61 incident response phases](9.1.1-NIST-SP-800-61-incident-response-phases.md)
- [→ Alternative incident response frameworks](9.1.3-Alternative-incident-response-frameworks.md)

...
- [↓ STIX/TAXII standards for threat intelligence sharing](9.4.2.1-STIXTAXII-standards-for-threat-intelligence-sharing.md)
- [↓ Open IOC databases: AlienVault OTX, MISP, ThreatConnect](9.4.2.2-Open-IOC-databases-AlienVault-OTX-MISP-ThreatConnect.md)
- [↓ Internal IOC tracking and enrichment](9.4.2.3-Internal-IOC-tracking-and-enrichment.md)

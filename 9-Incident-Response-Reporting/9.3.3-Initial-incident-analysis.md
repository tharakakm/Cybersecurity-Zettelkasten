...
- [↓ Scope determination: Affected systems and data](9.3.3.1-Scope-determination-Affected-systems-and-data.md)
- [↓ Attack vector and entry point identification](9.3.3.2-Attack-vector-and-entry-point-identification.md)
- [↓ Timeline construction and documentation](9.3.3.3-Timeline-construction-and-documentation.md)

**Related Topics at Same Level:**
- [→ Event vs incident classification](9.3.1-Event-vs-incident-classification.md)

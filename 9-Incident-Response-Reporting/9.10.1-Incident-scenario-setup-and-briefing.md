...
- [↓ Review simulated incident: Ransomware or phishing campaign](9.10.1.1-Review-simulated-incident-Ransomware-or-phishing-campaign.md)
- [↓ Identify initial indicators and alerts](9.10.1.2-Identify-initial-indicators-and-alerts.md)
- [↓ Assemble incident response team and assign roles](9.10.1.3-Assemble-incident-response-team-and-assign-roles.md)

**Related Topics at Same Level:**
- [→ Execute incident response procedures](9.10.2-Execute-incident-response-procedures.md)
- [→ Documentation and reporting](9.10.3-Documentation-and-reporting.md)

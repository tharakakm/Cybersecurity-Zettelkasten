...
**ID:** 9.6.2
**Level:** 3
**Parent:** [Eradication: Removing threats and closing attack vectors](9.6-Eradication-Removing-threats-and-closing-attack-vectors.md)
...
- [↓ Updating firewall rules and access controls](9.6.2.3-Updating-firewall-rules-and-access-controls.md)

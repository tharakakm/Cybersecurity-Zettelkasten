...
- [↓ Contain the incident: Isolate affected systems](9.10.2.1-Contain-the-incident-Isolate-affected-systems.md)
- [↓ Analyze IOCs and determine scope of compromise](9.10.2.2-Analyze-IOCs-and-determine-scope-of-compromise.md)
- [↓ Eradicate threats and recover systems](9.10.2.3-Eradicate-threats-and-recover-systems.md)

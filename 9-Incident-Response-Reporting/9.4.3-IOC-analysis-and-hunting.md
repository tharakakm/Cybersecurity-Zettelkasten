...
- [↓ Searching for IOCs across environment](9.4.3.1-Searching-for-IOCs-across-environment.md)
- [↓ Pivot analysis: Finding related indicators](9.4.3.2-Pivot-analysis-Finding-related-indicators.md)
- [↓ False positive IOC validation](9.4.3.3-False-positive-IOC-validation.md)

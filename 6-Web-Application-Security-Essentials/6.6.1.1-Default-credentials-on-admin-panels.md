...
**ID:** 6.6.1.1
**Level:** 4
**Parent:** [Common security misconfigurations](6.6.1-Common-security-misconfigurations.md)
**Tags:** #level4 #module6
...
- [→ Directory listing and information disclosure](6.6.1.2-Directory-listing-and-information-disclosure.md)
- [→ Verbose error messages and stack traces](6.6.1.3-Verbose-error-messages-and-stack-traces.md)

...
- [↓ Anti-CSRF tokens (synchronizer tokens)](6.4.2.1-Anti-CSRF-tokens-synchronizer-tokens.md)
- [↓ SameSite cookie attribute](6.4.2.2-SameSite-cookie-attribute.md)
- [↓ Double-submit cookie pattern](6.4.2.3-Double-submit-cookie-pattern.md)

...
- [↓ API keys, OAuth 2.0, JWT tokens](6.9.1.1-API-keys-OAuth-20-JWT-tokens.md)
- [↓ Bearer token vulnerabilities and protection](6.9.1.2-Bearer-token-vulnerabilities-and-protection.md)
- [↓ API authorization and scope management](6.9.1.3-API-authorization-and-scope-management.md)

...
**ID:** 6.4.3
**Level:** 3
**Parent:** [Cross-Site Request Forgery (CSRF) and prevention techniques](6.4-Cross-Site-Request-Forgery-CSRF-and-prevention-techniques.md)
**Tags:** #level3 #module6
...
- [↓ Identifying state-changing operations](6.4.3.1-Identifying-state-changing-operations.md)
- [↓ CSRF proof-of-concept (PoC) creation](6.4.3.2-CSRF-proof-of-concept-PoC-creation.md)
- [↓ Burp Suite CSRF PoC generator](6.4.3.3-Burp-Suite-CSRF-PoC-generator.md)

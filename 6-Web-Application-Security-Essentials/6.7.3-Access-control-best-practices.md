...
- [↓ Server-side authorization checks](6.7.3.1-Server-side-authorization-checks.md)
- [↓ Indirect object references and mapping tables](6.7.3.2-Indirect-object-references-and-mapping-tables.md)
- [↓ Deny by default and whitelist approach](6.7.3.3-Deny-by-default-and-whitelist-approach.md)

...
**ID:** 6.10.2.1
**Level:** 4
**Parent:** [Exploit common web vulnerabilities](6.10.2-Exploit-common-web-vulnerabilities.md)
...
- [→ Exploit XSS vulnerabilities (reflected, stored, DOM)](6.10.2.2-Exploit-XSS-vulnerabilities-reflected-stored-DOM.md)
- [→ Test CSRF, authentication bypass, and file upload issues](6.10.2.3-Test-CSRF-authentication-bypass-and-file-upload-issues.md)

...
**ID:** 6.2.1
**Level:** 3
**Parent:** [Injection attacks: SQL injection, command injection, LDAP injection](6.2-Injection-attacks-SQL-injection-command-injection-LDAP-injection.md)
...
- [↓ In-band SQLi: Union-based and error-based](6.2.1.1-In-band-SQLi-Union-based-and-error-based.md)
- [↓ Blind SQLi: Boolean-based and time-based](6.2.1.2-Blind-SQLi-Boolean-based-and-time-based.md)
- [↓ SQL injection payloads and database fingerprinting](6.2.1.3-SQL-injection-payloads-and-database-fingerprinting.md)

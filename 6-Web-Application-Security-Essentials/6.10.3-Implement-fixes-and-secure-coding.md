...
- [↓ Review vulnerable source code](6.10.3.1-Review-vulnerable-source-code.md)
- [↓ Apply secure coding fixes for each vulnerability](6.10.3.2-Apply-secure-coding-fixes-for-each-vulnerability.md)
- [↓ Verify fixes and create remediation documentation](6.10.3.3-Verify-fixes-and-create-remediation-documentation.md)

**Related Topics at Same Level:**
- [→ Setup vulnerable application environment](6.10.1-Setup-vulnerable-application-environment.md)

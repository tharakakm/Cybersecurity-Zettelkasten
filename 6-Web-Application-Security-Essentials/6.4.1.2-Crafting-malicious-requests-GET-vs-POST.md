...
**ID:** 6.4.1.2
**Level:** 4
**Parent:** [CSRF attack mechanism and exploitation](6.4.1-CSRF-attack-mechanism-and-exploitation.md)
...
- [→ Understanding session-based authentication vulnerability](6.4.1.1-Understanding-session-based-authentication-vulnerability.md)
- [→ CSRF impact: Account takeover, unauthorized actions](6.4.1.3-CSRF-impact-Account-takeover-unauthorized-actions.md)

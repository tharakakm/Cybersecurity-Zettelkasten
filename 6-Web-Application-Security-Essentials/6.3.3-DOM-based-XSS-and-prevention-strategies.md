...
- [↓ Client-side JavaScript vulnerabilities](6.3.3.1-Client-side-JavaScript-vulnerabilities.md)
- [↓ Dangerous sinks: innerHTML, eval, document.write](6.3.3.2-Dangerous-sinks-innerHTML-eval-documentwrite.md)
- [↓ Content Security Policy (CSP) implementation](6.3.3.3-Content-Security-Policy-CSP-implementation.md)

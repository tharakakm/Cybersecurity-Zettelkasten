...
- [↓ Time-based correlation windows](7.8.1.1-Time-based-correlation-windows.md)
- [↓ Multi-source event correlation](7.8.1.2-Multi-source-event-correlation.md)
- [↓ User and asset-based correlation](7.8.1.3-User-and-asset-based-correlation.md)

...
**ID:** 7.9.3.3
**Level:** 4
**Parent:** [Security monitoring use cases](7.9.3-Security-monitoring-use-cases.md)
...
- [↑ Security monitoring use cases](7.9.3-Security-monitoring-use-cases.md)

**Related Topics at Same Level:**
- [→ Failed login attempt monitoring](7.9.3.1-Failed-login-attempt-monitoring.md)
- [→ Privilege escalation detection](7.9.3.2-Privilege-escalation-detection.md)

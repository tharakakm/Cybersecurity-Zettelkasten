...
**ID:** 7.4.2.3
**Level:** 4
**Parent:** [Secure service configuration](7.4.2-Secure-service-configuration.md)
**Tags:** #level4 #module7
...
- [→ Disabling services: Telnet, FTP, legacy protocols](7.4.2.1-Disabling-services-Telnet-FTP-legacy-protocols.md)
- [→ Service startup types: Automatic, manual, disabled](7.4.2.2-Service-startup-types-Automatic-manual-disabled.md)

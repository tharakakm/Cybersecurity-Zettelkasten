...
**ID:** 7.8.2
**Level:** 3
**Parent:** [Log correlation and alert tuning to reduce false positives](7.8-Log-correlation-and-alert-tuning-to-reduce-false-positives.md)
**Tags:** #level3 #module7
...
- [↓ Baseline establishment and threshold tuning](7.8.2.1-Baseline-establishment-and-threshold-tuning.md)
- [↓ Suppression rules for known false positives](7.8.2.2-Suppression-rules-for-known-false-positives.md)
- [↓ Alert severity classification and prioritization](7.8.2.3-Alert-severity-classification-and-prioritization.md)

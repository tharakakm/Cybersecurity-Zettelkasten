...
**ID:** 7.9.1
**Level:** 3
**Parent:** [Security monitoring with Splunk or ELK Stack basics](7.9-Security-monitoring-with-Splunk-or-ELK-Stack-basics.md)
**Tags:** #level3 #module7
...
- [↓ Installing Splunk and adding data sources](7.9.1.1-Installing-Splunk-and-adding-data-sources.md)
- [↓ SPL (Search Processing Language) basics](7.9.1.2-SPL-Search-Processing-Language-basics.md)
- [↓ Creating dashboards and visualizations](7.9.1.3-Creating-dashboards-and-visualizations.md)

...
**ID:** 7.4.1
**Level:** 3
**Parent:** [Disabling unnecessary services and removing unused software](7.4-Disabling-unnecessary-services-and-removing-unused-software.md)
**Tags:** #level3 #module7
...
- [↓ Windows: services.msc, Get-Service, sc query](7.4.1.1-Windows-servicesmsc-Get-Service-sc-query.md)
- [↓ Linux: systemctl list-units, service --status-all](7.4.1.2-Linux-systemctl-list-units-service---status-all.md)
- [↓ Identifying non-essential services safely](7.4.1.3-Identifying-non-essential-services-safely.md)

...
- [↓ Deploy Splunk Free or ELK Stack in lab environment](7.10.1.1-Deploy-Splunk-Free-or-ELK-Stack-in-lab-environment.md)
- [↓ Configure log forwarding from Windows and Linux systems](7.10.1.2-Configure-log-forwarding-from-Windows-and-Linux-systems.md)
- [↓ Verify log ingestion and parsing](7.10.1.3-Verify-log-ingestion-and-parsing.md)

...
**ID:** 7.6.1.2
**Level:** 4
**Parent:** [Antivirus fundamentals and limitations](7.6.1-Antivirus-fundamentals-and-limitations.md)
**Tags:** #level4 #module7
...
- [→ Signature-based vs heuristic detection](7.6.1.1-Signature-based-vs-heuristic-detection.md)
- [→ False positives and whitelisting](7.6.1.3-False-positives-and-whitelisting.md)
